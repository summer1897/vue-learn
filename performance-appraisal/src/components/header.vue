<template>
        ...
        <!-- <ul class="layui-nav" :class="menuTypes[menuType]">       
            <li v-for="item in menuModel" class="layui-nav-item" :class="{'layui-this':menuIndex==item.Key,'layui-nav-itemed':(menuType==1 && menuIndex==item.Key && showItemIndex==item.Key)}">
